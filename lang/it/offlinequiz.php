...
$string['addquestionfrombanktopage'] = 'Aggiungi alla pagina dal {$a} deposito delle domande';
...
$string['configdisableimgnewlines'] = 'Quest\'opzione disabilita gli a-capo prima e dopo le immagini nel foglio domande. Attenzione: può causare dei problemi con la formattazione';
...
$string['configshufflewithin'] = 'Abilitando questa opzione le opzioni di risposta di ogni singola domanda verranno mischiate alla generazione dei foglio di domande e del modulo risposte.';
...
$string['disableimgnewlines'] = 'Disabilita nuova linea prima e dopo le immagini';
$string['disableimgnewlines_help'] = 'Questa opzione disabilita la creazione di nuove linee prima e dopo le immagini nel modulo risposte. ATTENZIONE: Può creare problemi di formattazione, verifica il risultato finale.';
...
$string['gradedscannedform'] = 'Modulo digitalizzato con i risultati';
...
Puoi importare la scansione di una singola immagine oppure più scansioni all\'interno di un archivio ZIP. Il modulo processerà i files in backround. Il nome del file non è rilevamente, ma ricorda di non utilizzare caratteri speciali (come ad esempio le dieresi). Le immagini possono essere in formato GIF, PNG o TIF. Si raccomanda di utilizzare una risoluzione tra 200 e 300 dpi.</p>';
...
$string['modulename_help'] = 'Questo moduolo consente al docente di creare quiz offline con domande a risposta multipla.
Le domande vengono gestite nel deposito domande di Moodle e possono essere riutilizzate. 
I quiz offline possono essere scaricati in formato PDF, DOCX o come file LaTeX. Gli studenti segnano le loro risposte all\'interno del modulo risposte. Questi moduli sono scansionati e quindi importati all\'interno del sistema, che in automatico procede alla loro correzione.';
...
$string['recreatepdfs'] = 'Rigenera i PDF';
$string['recurse'] = 'Icludi anche domande dalle sottocategorie';
$string['refreshpreview'] = 'Aggiorna anteprima';
$string['regrade'] = 'Rivaluta';
$string['regradedisplayexplanation'] = '<b>Attenzione:</b> la rivalutazione non modifica i punteggi che sono stati sovrascritti manualmente!';
$string['regradinginfo'] = 'Se modifichi il punteggio di una domando devi eseguire la rivalutazione per aggiornare i risultati.';
$string['regradingquiz'] = 'Rivalutazione';
$string['regradingresult'] = 'Rivalutazione incorso per l\'utente {$a}...';
...
$string['reviewincludes'] = 'Elementi inclusi';
...
$string['scannedform'] = 'Modulo digitalizzato';
...
$string['shufflewithin'] = 'Mischia le opzioni di risposta';
$string['shufflewithin_help'] = 'Se abilitata, le opzioni di risposta verranno riordinate casualmente ad ogni aggiornamento della pagina di anteprima. NOTA: Questa impostazione si applica solo alle domande che hanno già l\'opzione di ordinamento casuale attiva.';
...
$string['shufflequestions'] = 'Mischia le domande';
$string['numbergroups'] = 'Numero dei gruppi';